...
#include "limxsdk/wheellegged_sim.h"
...
namespace wheellegged_gazebo
{
  ...
  /**
   * @brief Class representing the WheelleggedHWSim simulation.
   */
  class WheelleggedHWSim : public gazebo_ros_control::DefaultRobotHWSim
  {
  public:
    /**
